...
--model_path="checkpoints/cbis_superpt_rn22_rn18_ep150_crop/val_best_model.pth" \
--data_path="/media/hdd/filipe/datasets/preprocessed_gmic/" \
--mask_dir="checkpoints/cbis_superpt_rn22_rn18_ep150_crop/masks" \
--output_path="checkpoints/cbis_superpt_rn22_rn18_ep150_crop/segmentation" \
--bs=2 \
