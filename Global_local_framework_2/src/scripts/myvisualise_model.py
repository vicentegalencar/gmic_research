...
if __name__ == '__main__':
    ...
    test_loader = get_dataloaderCBIS(DATA_PATH, 'test', image_size=img_size, batch_size=batch_size, shuffle=False, max_value=max_value, aug=aug, num_chan=args['num_chan'])
