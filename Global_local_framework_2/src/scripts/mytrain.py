...
def train_net(net, output_path, epochs, image_size, batch_size, optimizer, lr_scheduler, datapath, device, threshold, writer, \
    ...
    val_loader = get_dataloaderCBIS(datapath, 'test_rnd', image_size=image_size, batch_size=10, shuffle=False, max_value=max_value, aug=False, num_chan=num_chan)
    ...
    test_loader = get_dataloaderCBIS(datapath, 'test_rnd', image_size=image_size, batch_size=10, shuffle=False, max_value=max_value, aug=False, num_chan=num_chan)
