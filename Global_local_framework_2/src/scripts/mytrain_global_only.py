...
from src.modeling import gmic_global_only
...
from src.scripts.one_epoch import running_one_epoch_global_only, save_epoch
...
def train_net(net, output_path, epochs, image_size, batch_size, optimizer, lr_scheduler, datapath, device, threshold, writer, \
    ...
    for epoch in range(epochs):
        lr = running_one_epoch_global_only(epoch, output_path, net, train_loader, val_loader, criterion, optimizer, device, threshold, beta, train_loss, train_acc, \
...
if __name__ == '__main__':
    ...
    model = gmic_global_only.GMIC(parameters)
