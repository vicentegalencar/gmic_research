...
--model_path="checkpoints/vindr_rn22pt_rn18pt_ep50_superpt_k3_xgradcam/val_best_model.pth" \
--data_path="/media/hdd/filipe/datasets/vindr-mammo/1.0.0/" \
--mask_dir="checkpoints/vindr_rn22pt_rn18pt_ep50_superpt_k3_xgradcam/segmentation/masks" \
--output_path="checkpoints/vindr_rn22pt_rn18pt_ep50_superpt_k3_xgradcam/segmentation" \
--bs=4 \
